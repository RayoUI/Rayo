...
Every control's properties are automatically generated by the `[ReactiveClass]` source generator as `Style<T>` extension methods. This means **all** property names of a control are available as style setters with no additional code.
