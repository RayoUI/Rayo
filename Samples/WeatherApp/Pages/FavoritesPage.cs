...
public sealed class FavoritesPage(WeatherStore store) : Component
{
    ...
    private Frame? _cardsHost;

    public override VisualElement Build()
    {
        _cardsHost = new Frame()
            .Padding(0)
            .BorderThickness(0)
            ...
            .Content(new VStack()
                ...
                .Children(
                    ...
                    new Entry()
                        ...
                        .FocusBackground(WeatherUi.Surface(store.IsDark))
                        .FocusBorderBrush(WeatherUi.Accent)
