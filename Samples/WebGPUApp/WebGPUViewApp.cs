...
public class WebGPUViewApp : UserControl
{
    ...
    private static VisualElement BuildHeader() =>
        new VStack()
            ...
            .Spacing(4)
            .Children(
                new Label("WebGPU 3D Cube")
                    .FontSize(22)
                    .FontWeight(FontWeight.Bold)
                    .Foreground(Color.White),
                new Label("A live 3D scene rendered with an independent wgpu device")
                    .FontSize(12)
                ...
                new HStack()
                    ...
                    .Children(
                        ...
                        new Slider(0.1f, 4.0f, 1.0f)
                            .HorizontalAlignment(HorizontalAlignment.Stretch)
                            .TrackFillColor(new Color(255, 100, 50))
                ...
                new HStack()
                    ...
                    .Children(
                        ...
                        new Button()
                            ...
                            .Background(new Color(255, 100, 50))
                            .Height(30)
                            .FontSize(12)
                            .HorizontalAlignment(HorizontalAlignment.Stretch)
