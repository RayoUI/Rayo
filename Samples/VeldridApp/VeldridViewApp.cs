...
public class VeldridViewApp : UserControl
{
    ...
    private static VisualElement BuildHeader() =>
        new VStack()
            ...
            .Spacing(4)
            .Children(
                new Label("Veldrid 3D Cube")
                    .FontSize(22)
                    .FontWeight(FontWeight.Bold)
                    .Foreground(Color.White),
                new Label("A live 3D scene rendered with an independent Veldrid GraphicsDevice")
                    .FontSize(12)
                ...
                new HStack()
                    ...
                    .Children(
                        ...
                        new Slider(0.1f, 4.0f, 1.0f)
                            .HorizontalAlignment(HorizontalAlignment.Stretch)
                            .TrackFillColor(new Color(56, 189, 138))
                ...
                new HStack()
                    ...
                    .Children(
                        ...
                        new Button()
                            ...
                            .Background(new Color(56, 189, 138))
                            .Height(30)
                            .FontSize(12)
                            .HorizontalAlignment(HorizontalAlignment.Stretch)
